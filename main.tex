...
% MARCO TEÓRICO
% ═══════════════════════════════════════════
\addtocontents{toc}{\vspace{1em}\noindent\textbf{Marco Teórico}\par\vspace{0.3em}}
...
% DESARROLLO
% ═══════════════════════════════════════════
\addtocontents{toc}{\vspace{1em}\noindent\textbf{Desarrollo}\par\vspace{0.3em}}
...
% RESULTADOS
% ═══════════════════════════════════════════
\addtocontents{toc}{\vspace{1em}\noindent\textbf{Resultados}\par\vspace{0.3em}}
...
% CONCLUSIONES
% ═══════════════════════════════════════════
\addtocontents{toc}{\vspace{1em}\noindent\textbf{Conclusiones}\par\vspace{0.3em}}
...
% ═══════════════════════════════════════════
\addtocontents{toc}{\vspace{1em}\noindent\textbf{Competencias Desarrolladas}\par\vspace{0.3em}}

\chapter{Competencias desarrolladas y/o aplicadas}
\input{capitulos/competencias}

% --- Fuentes de información ---
\addtocontents{toc}{\vspace{1em}\noindent\textbf{Fuentes de Información}\par\vspace{0.3em}}
\printbibliography[title={Fuentes de información}]

% --- Anexos ---
\addtocontents{toc}{\vspace{1em}\noindent\textbf{Anexos}\par\vspace{0.3em}}
\appendix
\chapter{Anexos}
